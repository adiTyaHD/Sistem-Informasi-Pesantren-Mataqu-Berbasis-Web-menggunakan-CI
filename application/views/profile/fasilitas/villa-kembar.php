...
<div class="site-section">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg ml-auto ">
                <h2 class="site-section-heading mb-5 text-center"> Villa-Kembar : bagi peserta Ikhwan</h2>
                <p style="color:#353b48;font-size:16pt;"> Assalamu'alaikum Wr. Wb. Sahabat Quran</p>
                <p style="color:#353b48;font-size:16pt;"> Berikut beberapa dokumentasi dari <b>Villa Kembar</b> Megamendung yang digunakan sebagai tempat <b>Dauroh Al Quran 40 Hari Ma'had MataQu</b> bagi para peserta Ikhwan :</p>
                <p style="color:#353b48;font-size:16pt;"> Bangunan ini telah digunakan sebagai tempat dauroh bagi para peserta ikhwan, sejak Angkatan ke-26, setelah sebelumnya mengambil tempat di Vila Filadelfia, Vila Toduri, dan Vila Abah Herman.</p>

                <center>
                    <div class="video-thumb-grid">
                        <!-- Daft Punk - Human After All -->
                        <a href="https://www.youtube.com/watch?v=s2ucnO4pESU" data-youtube-id="s2ucnO4pESU" class="video-thumb js-trigger-video-modal">
                            <img class="video-banner-img" src="<?= base_url() ?>assets/images/rutevillakembar.png" alt="" width="750" />
                        </a>
                    </div>
                    <!-- <iframe width="50%" height="400" src="https://www.youtube.com/embed/s2ucnO4pESU" frameborder="2" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->
                </center>
            </div>
            <div class="container mt-5">
                <div class="row">
                    ...
                    <p style="color:#353b48;font-size:16pt;"> Demikianlah dokumentasi dari <b>Villa Kembar Megamendung: Tempat Dauroh Al Quran Ma'had MataQu Bagi Peserta Ikhwan.</b> Untuk info lebih lanjut dapat menghubungi : <a href="https://api.whatsapp.com/6287780220777?text=I'm%20Assalamualaikum%20in%20Bisa%20Minta%20Foto%20terbaru%20VillaKembar"> 0877-8022-0777 </a> Jazakumullohu Khoir. Wassalamu'alaikum Wr. Wb.</p>
                </div>
            </div>
        </div>
    </div>
