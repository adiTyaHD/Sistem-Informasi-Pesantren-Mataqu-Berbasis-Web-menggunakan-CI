<div class="site-blocks-cover inner-page" style="background-image : url(<?= base_url('assets/') ?>images/santrialquran1.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
...
<div class="site-section">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg ml-auto ">
                <h2 class="site-section-heading mb-5 text-center">Santri Reguler : Takhfiz Quran Mataqu</h2>
        ...
        <div class="row">
            <div class="col-lg">
                ...
                <h5 class="penjelasan mt-5"> &nbsp;&nbsp;Biaya Santri Reguler ? </h5>
            ...
            <div class="collapse" id="lihatselengkapnya">
                <div class="card card-body mb-5">
                    <ol style="color:#2c3e50; font-size:13pt;list-style-type:square;">
                        <p style="color:#2c3e50; font-size:13pt;"><b>Biaya Santri Reguler : Takhfiz Quran Mataqu</b></p>
        ...
        <div class="row">
            <div class="col-lg ml-auto mt-3">
                <h5 class="penjelasan mb-5"> &nbsp;&nbsp;Deskirpsi Program santri reguler : </h5>
                <p style="color:#353b48; font-size:14pt;text-align:justify;"><b>Program Santri Tahfizh Al Quran Hafal 30 Juz Mutqin dan Faham Terjemahnya</b>, adalah salah satu program unggulan <b>Pesatren Tahfidz Al Quran Ma'had MataQu, Megamendung, Bogor</b>, yang diperuntukkan putra/putri usia SMP ataupun SMA, agar dapat <b>menghafal Al Quran 30 Juz</b> dengan <b>hafalan yang kokoh (mutqin)</b>. Program ini kami rancang dengan waktu pendidikan <b>minimal 3 (tiga) tahun</b> dan maksimal <b>6 (enam) tahun</b>, dengan kesempatan mendapatkan <b>ijazah resmi SMP atau SMA </b>lewat jalur resmi <a href="https://www.unbk.net/">
                        UNBK/USBN</a> dari sekolah mitra yang bekerjasama dengan pihak pesantren.</p>
                ...
                <p>
                    <h5 class="penjelasan"> &nbsp;&nbsp;Jadwal pendaftaran serta persyaratan santri Al-Quran </h5>
...
<div class="row">
    <div class="col-lg ml-auto mt-5 ">
        <h2 class="site-section-heading mb-5 text-center"><b>GALERI KEGIATAN Santri Al-Quran</b></h2>
        <div class="row">
